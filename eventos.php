<?php
//Muestra los eventos para los usuarios no logeados
session_start();
    ...
    <section class="w3-content w3-container w3-padding-64" id="explora">
        ...
        <div class="w3-row w3-grayscale-min" id="categoriasExplorar">
            ...
            foreach ($categorias as $categoria) {
                ...
                echo '<a href="eventosCategoria.php?categoria=' . $categoria['nombre'] . '"><img src = "' . $categoria['imagen'] . '" style = "width:100%" alt = "' . $categoria['descripcion'] . '"></a>';
                echo '</div>';
            }
            ?>           
        </div>
        ...
        <div class="w3-center w3-padding-32">
            <div class="w3-bar">
                <a href="eventos.php?pagina=<?php echo $valoresPaginacion["paginaAnt"] ?>" class="w3-bar-item w3-button w3-hover-black">«</a>
            
            <?php
            for($i = 0; $i < $valoresPaginacion["paginaMaxima"]; $i++){
                echo '<a href="eventos.php?pagina=' .($i + 1). '" class="w3-bar-item w3-black w3-button">' .($i + 1). '</a>';
            }
            
            ?>
                <a href="eventos.php?pagina=<?php echo $valoresPaginacion["paginaSig"] ?>" class="w3-bar-item w3-button w3-hover-black">»</a>
            </div>
        </div>
    </section>
</article>
